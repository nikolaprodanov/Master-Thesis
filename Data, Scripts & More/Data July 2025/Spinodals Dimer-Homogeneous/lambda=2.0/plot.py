...
def plot_first_two_columns_skip_comments():
    ...
    inset_ax.set_ylim(0,0.11)

    inset_ax.set_title("Zoom: 0.5 to 0.6")
    inset_ax.tick_params(axis='both', which='major', labelsize=8)

    plt.tight_layout()
    plt.savefig('results_lambda=2.0.png')
    plt.show()
    plt.close()
